...
class Face_Recognition:
    def __init__(self,root):
        ...
        # 1st Image
        img_top=Image.open(r"college_images\face1.png")
        ...
        # 2nd Iamge
        img_bottom=Image.open(r"college_images\face2.png")
        ...
        # Button
        b1=Button(f_lbl,text="Face Recognition",cursor="hand2",command=self.face_recog,font=("times new roman",18,"bold"),bg="dark green",fg="white")
        b1.place(x =365,y=620,width=200,height=40)

    # Attendance
    def mark_attendance(self,i,r,n,d):
        with open("supriyo.csv","r+",newline="\n") as f:
